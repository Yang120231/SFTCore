...
public class SGTLangHandler extends LangHandler {
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("sftcore.multiblock.gcym_energy_multiplier.tooltip", "§a- §lEnergy Multiplier§r§a: %f§r");
        provider.add("sftcore.multiblock.gcym_time_multiplier.tooltip", "§9- §lTime Multiplier§r§9: %f§r");
        ...
        provider.add("sftcore.machine.huge_parallel_hatch_mk5.tooltip", "Allows to run up to 64 recipes in parallel.");
        provider.add("sftcore.machine.huge_parallel_hatch_mk6.tooltip", "Allows to run up to 256 recipes in parallel.");
        provider.add("sftcore.machine.huge_parallel_hatch_mk7.tooltip", "Allows to run up to 1024 recipes in parallel.");
        provider.add("sftcore.machine.huge_parallel_hatch_mk8.tooltip", "Allows to run up to 4096 recipes in parallel.");
        provider.add("sftcore.machine.modified_by_sft", "§b§n§o- Modified By SFT§r§r§r§b§n -§r§r");

        // machines
        provider.add("block.sftcore.desulfurizer.tooltip", "Desulfurize oil efficiently.");
        provider.add("block.sftcore.oil_drilling_rig.tooltip", "Oh, It's not so environmental friendly...");
        provider.add("block.sftcore.semiconductor_blast_furnace.tooltip", "Expert in producing semiconductor.");
        provider.add("block.sftcore.large_inscriber.tooltip", "A large inscriber for advanced circuits.");
        provider.add("block.sftcore.greenhouse.tooltip", "Hope our plants can grow well.");
        provider.add("block.sftcore.certus_quartz_charger.tooltip", "Release the power of Certus Quartz.");
        provider.add("block.sftcore.large_mekanism_nuclear_reactor.tooltip", "Extract energy from fuel thoroughly.");
    }
}
